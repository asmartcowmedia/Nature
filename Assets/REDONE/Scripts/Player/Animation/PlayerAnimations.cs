...
namespace CampingTrip
{
    public class PlayerAnimations : MonoBehaviour
    {
        ...
        private void Attack() // Function to play attack animation when attacking
        {
            ...
            if (!attack.WasPressedThisFrame() || attackAnimator.GetBool(anim[0]) || playerStamina.staminaStats.currentStamina <= 10 + 1) return;
            
            // call the attack on the player attack script
            playerAttack.CallAttack();
            
            // call hit box and bool
